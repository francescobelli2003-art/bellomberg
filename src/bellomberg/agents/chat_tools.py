...
def dispatch(tool_name: str, tool_input: Dict[str, Any], caller: str = None, *,
    ...
    try:
        ...
        if tool_name == "get_valuation":
            ...
            if isinstance(r, dict) and r.get("engine") == "rab" and r.get("ok"):
            ...
            if isinstance(r, dict) and r.get("engine") in ("bank", "insurance") and not tool_input.get("roe_path"):
            ...
            if isinstance(r, dict) and not tool_input.get("growth_path") and str(r.get("engine") or "").startswith("operating"):
            ...
            _gn = _guidance_drift_nudge(r, tool_input.get("variant_view"))
            if _gn:
            ...
            if isinstance(r, dict) and r.get("ok") and r.get("fair_value_sotp") is not None:
            ...
            elif isinstance(r, dict) and r.get("ok") and r.get("sotp_note"):
